            ...
            for m in MODELS:
                ...
                for seed in range(n_seeds):
                    ...
                    model = create_metric_model(
                        ...
                        use_mamba=False  # V1 baseline: no Mamba
                    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Neuro-Biometrics v1 baseline pipeline")
    ...
    if args.smoke:
        print("Usage: python experiments/v1_baseline/main.py --smoke")
        run_smoke_test(config)
    elif args.mini_train:
        print("Usage: python experiments/v1_baseline/main.py --mini-train")
        run_mini_train(config)
    elif args.one_sample:
        print("Usage: python experiments/v1_baseline/main.py --one-sample")
