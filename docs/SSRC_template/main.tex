...
\markboth{STUDENT SCIENTIFIC RESEARCH COMMUNICATION, Volume II, 2025}
{Author \MakeLowercase{\textit{et al.}}: Preparation of Papers for
Review by the \textsc{Student Scientific Research Communication} \newline (March 2025)}
\begin{document}
\title{Preparation of Papers for Review by the \textsc{Student Scientific Research Communication}}
